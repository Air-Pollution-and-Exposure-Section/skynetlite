purpleair_data_new = """
create materialized view purpleair_data_new as (select distinct instrument_id_a as instrument_id,
											                ...
											                round(get_average(pm1_atm_a, pm1_atm_b), 2) as pm1atm,
											               	round(get_pm25_corrected(pm25_atm_a, pm25_atm_b), 2) as pm25atm,
											               	round(get_average(pm10_atm_a, pm10_atm_b), 2) as pm10atm,
											               	round(get_average(pm1_cf_1_a, pm1_cf_1_b), 2) as pm1cf1,
											               	round(get_average(pm25_cf_1_a, pm25_cf_1_b), 2) as pm25cf1,
											               	round(get_average(pm10_cf_1_a, pm10_cf_1_b), 2) as pm10cf1,
