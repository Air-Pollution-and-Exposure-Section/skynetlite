purpleair_data_schefferville = """
create materialized view purpleair_data_schefferville as (select distinct instrument_id_a as instrument_id,
																		instrument.label,
																		time_by_hour_a - interval '5 hour' as time,
																		channel_a_primary_data_resampled_hour.latitude as latitude,
																		channel_a_primary_data_resampled_hour.longitude as longitude,
														...
														inner join instrument on instrument_id_a=instrument.id
														...
														and study.name = 'Schefferville Air Polution Study'
