...
create or replace function insert_new_channel_a_secondary_data(instrument_id int, my_latitude numeric, my_longitude numeric, location_type text) returns void as $function$
	begin
		insert into channel_a_secondary_data(instrument_id, time, latitude, longitude, um3, um5, um1, um25, um50, um10, PM1_cf_1, PM10_cf_1, device_location_type)
