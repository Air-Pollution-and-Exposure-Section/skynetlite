channel_a_primary_data_resampled_hour = """
create or replace view channel_a_primary_data_resampled_hour as (select instrument_id as instrument_id_a, 
																   date_trunc('hour', time) as time_by_hour_a, 
																   latitude,
																   longitude, 
															...
															group by 1, time_by_hour_a, latitude, longitude, device_location_type 
															order by time_by_hour_a asc);
"""