channel_a_secondary_data_resampled_minute = """
create or replace view channel_a_secondary_data_resampled_minute as (select instrument_id as instrument_id_c,
																	 date_trunc('minute', time) as time_by_minute_c,
															 ...
															 group by 1, time_by_minute_c
															 order by time_by_minute_c asc);
"""